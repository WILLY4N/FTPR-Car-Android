        ...
        val options = PhoneAuthOptions.newBuilder(auth)
            ...
            .setCallbacks(object : PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
                ...
                override fun onVerificationFailed(excepition: FirebaseException) {
                    Toast.makeText(this@LoginActivity, "${excepition.message}", Toast.LENGTH_LONG).show()
                }
                ...
                override fun onCodeSent(verificationId: String, token: PhoneAuthProvider.ForceResendingToken) {
                    ...
                    Toast.makeText(this@LoginActivity, "Código de verificação enviado via SMS", Toast.LENGTH_LONG).show()
                }
            })
            .build()
